    ...
    public partial class SquashMigrationSqlite : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table => table.PrimaryKey("PK_Materials", x => x.Id)
            );
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table =>
                    new
                    {
                        ...
                        QuantitativeNominalValue = table.Column<double>(
                            type: "REAL",
                            nullable: true
                        ),
                        QuantitativeInferiorLimit = table.Column<double>(
                            type: "REAL",
                            nullable: true
                        ),
                        QuantitativeSuperiorLimit = table.Column<double>(
                            type: "REAL",
                            nullable: true
                        )
                    },
                constraints: table => table.PrimaryKey("PK_QualityProperties", x => x.Id)
            );
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table =>
                    new
                    {
                        ...
                        AvaliationCalculationType = table.Column<string>(
                            type: "TEXT",
                            nullable: false
                        ),
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "QualityVisionProperties");

            migrationBuilder.DropTable(name: "MaterialBatches");

            migrationBuilder.DropTable(name: "QualityProperties");

            migrationBuilder.DropTable(name: "QualityVisions");
